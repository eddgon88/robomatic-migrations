...
--
-- Name: ai_agent; Type: TABLE; Schema: core; Owner: -
--
...
CREATE TABLE core.ai_agent (
    ...
    llm character varying(100) NOT NULL,
...
--
-- Name: ai_agent_folder; Type: TABLE; Schema: core; Owner: -
--

CREATE TABLE core.ai_agent_folder (
    id integer NOT NULL,
    name character varying(255) NOT NULL,
    parent_id integer,
    user_id integer NOT NULL
...
--
-- Name: ai_agent_folder_id_seq; Type: SEQUENCE; Schema: core; Owner: -
--

CREATE SEQUENCE core.ai_agent_folder_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: ai_agent_folder_id_seq; Type: SEQUENCE OWNED BY; Schema: core; Owner: -
--

ALTER SEQUENCE core.ai_agent_folder_id_seq OWNED BY core.ai_agent_folder.id;


--
-- Name: ai_agent_id_seq; Type: SEQUENCE; Schema: core; Owner: -
--

CREATE SEQUENCE core.ai_agent_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: ai_agent_id_seq; Type: SEQUENCE OWNED BY; Schema: core; Owner: -
--

ALTER SEQUENCE core.ai_agent_id_seq OWNED BY core.ai_agent.id;


--
-- Name: ai_interaction; Type: TABLE; Schema: core; Owner: -
--
...
--
-- Name: ai_interaction_id_seq; Type: SEQUENCE; Schema: core; Owner: -
--

CREATE SEQUENCE core.ai_interaction_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: ai_interaction_id_seq; Type: SEQUENCE OWNED BY; Schema: core; Owner: -
--

ALTER SEQUENCE core.ai_interaction_id_seq OWNED BY core.ai_interaction.id;
...
--
-- Name: credential_type; Type: TABLE; Schema: core; Owner: -
--
...
--
-- Name: TABLE credential_type; Type: COMMENT; Schema: core; Owner: -
--
...
--
-- Name: COLUMN credential_type.id; Type: COMMENT; Schema: core; Owner: -
--
...
--
-- Name: COLUMN credential_type.name; Type: COMMENT; Schema: core; Owner: -
--
...
--
-- Name: COLUMN credential_type.description; Type: COMMENT; Schema: core; Owner: -
--
...
--
-- Name: credential_type_id_seq; Type: SEQUENCE; Schema: core; Owner: -
--

CREATE SEQUENCE core.credential_type_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: credential_type_id_seq; Type: SEQUENCE OWNED BY; Schema: core; Owner: -
--

ALTER SEQUENCE core.credential_type_id_seq OWNED BY core.credential_type.id;
...
--
-- Name: schedule; Type: TABLE; Schema: core; Owner: -
--
...
--
-- Name: TABLE schedule; Type: COMMENT; Schema: core; Owner: -
--
...
--
-- Name: COLUMN schedule.schedule_id; Type: COMMENT; Schema: core; Owner: -
--
...
--
-- Name: COLUMN schedule.trigger_type; Type: COMMENT; Schema: core; Owner: -
--
...
--
-- Name: COLUMN schedule.expression; Type: COMMENT; Schema: core; Owner: -
--
...
--
-- Name: COLUMN schedule.status; Type: COMMENT; Schema: core; Owner: -
--
...
--
-- Name: schedule_id_seq; Type: SEQUENCE; Schema: core; Owner: -
--

CREATE SEQUENCE core.schedule_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: schedule_id_seq; Type: SEQUENCE OWNED BY; Schema: core; Owner: -
--

ALTER SEQUENCE core.schedule_id_seq OWNED BY core.schedule.id;
...
--
-- Name: test_ai_agent; Type: TABLE; Schema: core; Owner: -
--

CREATE TABLE core.test_ai_agent (
    test_id integer NOT NULL,
...
--
-- Name: test_credential; Type: TABLE; Schema: core; Owner: -
--
...
--
-- Name: TABLE test_credential; Type: COMMENT; Schema: core; Owner: -
--
...
--
-- Name: COLUMN test_credential.id; Type: COMMENT; Schema: core; Owner: -
--
...
--
-- Name: COLUMN test_credential.credential_id; Type: COMMENT; Schema: core; Owner: -
--
...
--
-- Name: COLUMN test_credential.test_id; Type: COMMENT; Schema: core; Owner: -
--
...
--
-- Name: COLUMN test_credential.credential_type_id; Type: COMMENT; Schema: core; Owner: -
--
...
--
-- Name: COLUMN test_credential.name; Type: COMMENT; Schema: core; Owner: -
--
...
--
-- Name: COLUMN test_credential.encrypted_value; Type: COMMENT; Schema: core; Owner: -
--
...
--
-- Name: COLUMN test_credential.file_path; Type: COMMENT; Schema: core; Owner: -
--
...
--
-- Name: COLUMN test_credential.file_name; Type: COMMENT; Schema: core; Owner: -
--
...
--
-- Name: COLUMN test_credential.created_at; Type: COMMENT; Schema: core; Owner: -
--
...
--
-- Name: COLUMN test_credential.updated_at; Type: COMMENT; Schema: core; Owner: -
--
...
--
-- Name: test_credential_id_seq; Type: SEQUENCE; Schema: core; Owner: -
--

CREATE SEQUENCE core.test_credential_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: test_credential_id_seq; Type: SEQUENCE OWNED BY; Schema: core; Owner: -
--

ALTER SEQUENCE core.test_credential_id_seq OWNED BY core.test_credential.id;
...
--
-- Name: test_execution_counter; Type: TABLE; Schema: core; Owner: -
--

CREATE TABLE core.test_execution_counter (
    id integer NOT NULL,
    test_id integer NOT NULL,
...
--
-- Name: test_execution_counter_id_seq; Type: SEQUENCE; Schema: core; Owner: -
--

CREATE SEQUENCE core.test_execution_counter_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: test_execution_counter_id_seq; Type: SEQUENCE OWNED BY; Schema: core; Owner: -
--

ALTER SEQUENCE core.test_execution_counter_id_seq OWNED BY core.test_execution_counter.id;
...
CREATE TABLE core."user" (
    ...
    encrypted_pass character varying(60)
);
...
--
-- Name: COLUMN "user".encrypted_pass; Type: COMMENT; Schema: core; Owner: -
--
...
--
-- Name: ai_agent id; Type: DEFAULT; Schema: core; Owner: -
--

ALTER TABLE ONLY core.ai_agent ALTER COLUMN id SET DEFAULT nextval('core.ai_agent_id_seq'::regclass);


--
-- Name: ai_agent_folder id; Type: DEFAULT; Schema: core; Owner: -
--

ALTER TABLE ONLY core.ai_agent_folder ALTER COLUMN id SET DEFAULT nextval('core.ai_agent_folder_id_seq'::regclass);


--
-- Name: ai_interaction id; Type: DEFAULT; Schema: core; Owner: -
--

ALTER TABLE ONLY core.ai_interaction ALTER COLUMN id SET DEFAULT nextval('core.ai_interaction_id_seq'::regclass);
...
--
-- Name: credential_type id; Type: DEFAULT; Schema: core; Owner: -
--

ALTER TABLE ONLY core.credential_type ALTER COLUMN id SET DEFAULT nextval('core.credential_type_id_seq'::regclass);
...
--
-- Name: schedule id; Type: DEFAULT; Schema: core; Owner: -
--

ALTER TABLE ONLY core.schedule ALTER COLUMN id SET DEFAULT nextval('core.schedule_id_seq'::regclass);
...
--
-- Name: test_credential id; Type: DEFAULT; Schema: core; Owner: -
--

ALTER TABLE ONLY core.test_credential ALTER COLUMN id SET DEFAULT nextval('core.test_credential_id_seq'::regclass);
...
--
-- Name: test_execution_counter id; Type: DEFAULT; Schema: core; Owner: -
--

ALTER TABLE ONLY core.test_execution_counter ALTER COLUMN id SET DEFAULT nextval('core.test_execution_counter_id_seq'::regclass);
...
--
-- Name: ai_agent_folder ai_agent_folder_pkey; Type: CONSTRAINT; Schema: core; Owner: -
--

ALTER TABLE ONLY core.ai_agent_folder
    ADD CONSTRAINT ai_agent_folder_pkey PRIMARY KEY (id);


--
-- Name: ai_agent ai_agent_name_key; Type: CONSTRAINT; Schema: core; Owner: -
--

ALTER TABLE ONLY core.ai_agent
    ADD CONSTRAINT ai_agent_name_key UNIQUE (name);


--
-- Name: ai_agent ai_agent_pkey; Type: CONSTRAINT; Schema: core; Owner: -
--
...
--
-- Name: ai_interaction ai_interaction_pkey; Type: CONSTRAINT; Schema: core; Owner: -
--

ALTER TABLE ONLY core.ai_interaction
    ADD CONSTRAINT ai_interaction_pkey PRIMARY KEY (id);
...
--
-- Name: credential_type credential_type_pkey; Type: CONSTRAINT; Schema: core; Owner: -
--

ALTER TABLE ONLY core.credential_type
    ADD CONSTRAINT credential_type_pkey PRIMARY KEY (id);
...
--
-- Name: schedule schedule_pkey; Type: CONSTRAINT; Schema: core; Owner: -
--

ALTER TABLE ONLY core.schedule
    ADD CONSTRAINT schedule_pkey PRIMARY KEY (id);


--
-- Name: schedule schedule_schedule_id_key; Type: CONSTRAINT; Schema: core; Owner: -
--
...
--
-- Name: test_ai_agent test_ai_agent_pkey; Type: CONSTRAINT; Schema: core; Owner: -
--

ALTER TABLE ONLY core.test_ai_agent
    ADD CONSTRAINT test_ai_agent_pkey PRIMARY KEY (test_id, ai_agent_id);
...
--
-- Name: test_credential test_credential_credential_id_key; Type: CONSTRAINT; Schema: core; Owner: -
--

ALTER TABLE ONLY core.test_credential
    ADD CONSTRAINT test_credential_credential_id_key UNIQUE (credential_id);


--
-- Name: test_credential test_credential_pkey; Type: CONSTRAINT; Schema: core; Owner: -
--

ALTER TABLE ONLY core.test_credential
    ADD CONSTRAINT test_credential_pkey PRIMARY KEY (id);


--
-- Name: test_credential test_credential_test_id_name_key; Type: CONSTRAINT; Schema: core; Owner: -
--

ALTER TABLE ONLY core.test_credential
    ADD CONSTRAINT test_credential_test_id_name_key UNIQUE (test_id, name);


--
-- Name: test_execution_counter test_execution_counter_pkey; Type: CONSTRAINT; Schema: core; Owner: -
--

ALTER TABLE ONLY core.test_execution_counter
    ADD CONSTRAINT test_execution_counter_pkey PRIMARY KEY (id);
...
--
-- Name: test_execution_counter uk_test_date; Type: CONSTRAINT; Schema: core; Owner: -
--

ALTER TABLE ONLY core.test_execution_counter
    ADD CONSTRAINT uk_test_date UNIQUE (test_id, year, month);
...
--
-- Name: credential_id_idx; Type: INDEX; Schema: core; Owner: -
--

CREATE UNIQUE INDEX credential_id_idx ON core.test_credential USING btree (credential_id);
...
--
-- Name: idx_folder_parent_folder_id; Type: INDEX; Schema: core; Owner: -
--

CREATE INDEX idx_folder_parent_folder_id ON core.folder USING btree (folder_id);


--
-- Name: INDEX idx_folder_parent_folder_id; Type: COMMENT; Schema: core; Owner: -
--
...
--
-- Name: idx_schedule_status; Type: INDEX; Schema: core; Owner: -
--

CREATE INDEX idx_schedule_status ON core.schedule USING btree (status);


--
-- Name: idx_schedule_test_id; Type: INDEX; Schema: core; Owner: -
--

CREATE INDEX idx_schedule_test_id ON core.schedule USING btree (test_id);
...
--
-- Name: test_credential_test_id_idx; Type: INDEX; Schema: core; Owner: -
--

CREATE INDEX test_credential_test_id_idx ON core.test_credential USING btree (test_id);
...
--
-- Name: uk_super_admin; Type: INDEX; Schema: core; Owner: -
--

CREATE UNIQUE INDEX uk_super_admin ON core."user" USING btree (role_id) WHERE (role_id = 5);
...
--
-- Name: action fk_action_ai_agent; Type: FK CONSTRAINT; Schema: core; Owner: -
--

ALTER TABLE ONLY core.action
    ADD CONSTRAINT fk_action_ai_agent FOREIGN KEY (ai_agent_id) REFERENCES core.ai_agent(id);


--
-- Name: action fk_action_ai_agent_folder; Type: FK CONSTRAINT; Schema: core; Owner: -
--

ALTER TABLE ONLY core.action
    ADD CONSTRAINT fk_action_ai_agent_folder FOREIGN KEY (ai_agent_folder_id) REFERENCES core.ai_agent_folder(id);
...
--
-- Name: ai_agent fk_ai_agent_folder; Type: FK CONSTRAINT; Schema: core; Owner: -
--

ALTER TABLE ONLY core.ai_agent
    ADD CONSTRAINT fk_ai_agent_folder FOREIGN KEY (folder_id) REFERENCES core.ai_agent_folder(id) ON DELETE SET NULL;


--
-- Name: ai_agent_folder fk_ai_agent_folder_parent; Type: FK CONSTRAINT; Schema: core; Owner: -
--

ALTER TABLE ONLY core.ai_agent_folder
    ADD CONSTRAINT fk_ai_agent_folder_parent FOREIGN KEY (parent_id) REFERENCES core.ai_agent_folder(id) ON DELETE CASCADE;


--
-- Name: ai_agent_folder fk_ai_agent_folder_user; Type: FK CONSTRAINT; Schema: core; Owner: -
--

ALTER TABLE ONLY core.ai_agent_folder
    ADD CONSTRAINT fk_ai_agent_folder_user FOREIGN KEY (user_id) REFERENCES core."user"(id);


--
-- Name: ai_agent fk_ai_agent_user; Type: FK CONSTRAINT; Schema: core; Owner: -
--

ALTER TABLE ONLY core.ai_agent
    ADD CONSTRAINT fk_ai_agent_user FOREIGN KEY (user_id) REFERENCES core."user"(id);


--
-- Name: ai_interaction fk_ai_interaction_execution; Type: FK CONSTRAINT; Schema: core; Owner: -
--

ALTER TABLE ONLY core.ai_interaction
    ADD CONSTRAINT fk_ai_interaction_execution FOREIGN KEY (test_execution_id) REFERENCES core.test_execution(id) ON DELETE CASCADE;
...
--
-- Name: schedule fk_schedule_test; Type: FK CONSTRAINT; Schema: core; Owner: -
--

ALTER TABLE ONLY core.schedule
    ADD CONSTRAINT fk_schedule_test FOREIGN KEY (test_id) REFERENCES core.test(id) ON DELETE CASCADE;


--
-- Name: test_execution_counter fk_test; Type: FK CONSTRAINT; Schema: core; Owner: -
--

ALTER TABLE ONLY core.test_execution_counter
    ADD CONSTRAINT fk_test FOREIGN KEY (test_id) REFERENCES core.test(id);


--
-- Name: test_ai_agent fk_test_ai_agent_agent; Type: FK CONSTRAINT; Schema: core; Owner: -
--

ALTER TABLE ONLY core.test_ai_agent
    ADD CONSTRAINT fk_test_ai_agent_agent FOREIGN KEY (ai_agent_id) REFERENCES core.ai_agent(id) ON DELETE CASCADE;


--
-- Name: test_ai_agent fk_test_ai_agent_test; Type: FK CONSTRAINT; Schema: core; Owner: -
--

ALTER TABLE ONLY core.test_ai_agent
    ADD CONSTRAINT fk_test_ai_agent_test FOREIGN KEY (test_id) REFERENCES core.test(id) ON DELETE CASCADE;


--
-- Name: test_credential fk_test_credential_test; Type: FK CONSTRAINT; Schema: core; Owner: -
--

ALTER TABLE ONLY core.test_credential
    ADD CONSTRAINT fk_test_credential_test FOREIGN KEY (test_id) REFERENCES core.test(id) ON DELETE CASCADE;


--
-- Name: test_credential fk_test_credential_type; Type: FK CONSTRAINT; Schema: core; Owner: -
--

ALTER TABLE ONLY core.test_credential
    ADD CONSTRAINT fk_test_credential_type FOREIGN KEY (credential_type_id) REFERENCES core.credential_type(id);
