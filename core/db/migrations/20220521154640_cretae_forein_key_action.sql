...
ALTER TABLE "core"."action" ADD CONSTRAINT "fk_folder_id" FOREIGN KEY ("folder_id") REFERENCES "core"."folder" ("id") ON UPDATE CASCADE;
ALTER TABLE "core"."action" ADD CONSTRAINT "fk_test_id" FOREIGN KEY ("test_id") REFERENCES "core"."test" ("id") ON UPDATE CASCADE;
